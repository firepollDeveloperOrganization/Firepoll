...
const Navbar = (props) => (
  <header className="navbar">
    ...
    <nav className="user-nav">
      <a href="/create" className="user-nav__button-box">
        <span className="user-nav__button">Create Poll &nbsp;<i className="fa-fw far fa-calendar-plus"></i></span>
      </a>
      <a href="/dashboard" className="user-nav__button-box">
        <span className="user-nav__button">Dashboard &nbsp;<i className="fa-fw fas fa-home"></i></span>
      </a>
      <a href="#" className="user-nav__button-box" onClick={props.logout}>
        <span className="user-nav__button">Log Out &nbsp;<i className="fa-fw fas fa-sign-out-alt"></i></span>
      </a>
    </nav>
  </header>
